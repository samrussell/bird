	   ...
	   rte *new, rte *old, struct ea_list *eattrs)
{
  ...
  log_msg("prefix: %u.%u.%u.%u/%d", ((unsigned char *)(&(net->n.prefix)))[3], ((unsigned char *)(&(net->n.prefix)))[2], ((unsigned char *)(&(net->n.prefix)))[1], ((unsigned char *)(&(net->n.prefix)))[0], net->n.pxlen);
